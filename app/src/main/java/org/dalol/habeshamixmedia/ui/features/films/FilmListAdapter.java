 ...
 */
public class FilmListAdapter extends BaseListAdapter<FilmListAdapter.FilmItemViewHolder, YoutubeVideoVO> {

    FilmListAdapter(Context context) {
        super(context);
    }
    ...
    public FilmItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new FilmItemViewHolder(getLayoutInflater().inflate(R.layout.item_video_layout, parent, false));
    }
    ...
    class FilmItemViewHolder extends BaseViewHolder<YoutubeVideoVO> implements View.OnClickListener {
        ...
        FilmItemViewHolder(View itemView) {
            super(itemView);
